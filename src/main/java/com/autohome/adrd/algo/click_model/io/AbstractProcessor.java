...
public abstract class AbstractProcessor implements Tool {
	...
	protected void setupOptions() {
		...
		_options.addOption(input).addOption(output).addOption(numReduce).addOption(jarpath).addOption(input_zebra).addOption(help).addOption(input_seq).addOption(output_seq);
	}
	...
	protected static Path[] readFolder(Path path, Configuration conf) throws IOException {
